...
func main() {
	...
	app := &cli.App{
		...
		Flags: []cli.Flag{
			...
			&cli.BoolFlag{
				Name: defs.OptionProgressJSON,
				Usage: "Emit newline-delimited JSON progress events on stderr.\n" +
					"\tRequires --json",
			},
			&cli.StringFlag{
				Name:  defs.OptionProxy,
				Usage: "Use an explicit socks5h:// loopback proxy and resolve through it",
			},
			&cli.BoolFlag{
